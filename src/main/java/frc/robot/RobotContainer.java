...
public class RobotContainer {
  ...
  private void configureButtonBindings() 
  {
    ...
    climb = new JoystickButton(mainDriver, 1);
    descend= new JoystickButton(mainDriver, 2);

    // three.toggleWhenPressed(new SwitchLED());
    // two.toggleWhenPressed(new CamMode());
    climb.toggleWhenPressed(new ClimbNow(true,Constants.CLIMBSPEED));
    descend.toggleWhenPressed(new ClimbNow(false,Constants.CLIMBSPEED));
    // climb.whileHeld(new ClimbNow(true,Constants.CLIMBSPEED));
    // descend.whileHeld(new ClimbNow(false,Constants.CLIMBSPEED));
